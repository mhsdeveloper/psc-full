...
export default {
	...
	methods: {
		...
		/*
			...
			+text_merge:(+overrated +think)



			OBJ: person_keyword, require
...
console.log(raw);
	...
	mounted(){
		...
		var solrSetup =	{
			...
			//this is called when the part of the browser's URL's after the # gets changed
			hashUpdateCallback: () => {
				//we won't use this. Instead, App will always adjust UI -> Hash -> call SOLR
			}
		}
		...
		solrSetup.url = Env.searchAPIURL;
