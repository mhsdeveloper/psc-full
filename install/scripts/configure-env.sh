...
sudo cp -r /psc/www/html/install/views /psc/www/html/publications/template/
...
sudo sed -i "s|\[\[EDIT-THIS-DOMAIN-NAME\]\]|$domainname|g" /psc/www/html/configure-wp-step3.sh
