...
if ( ! class_exists( 'PSC_1_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since PSC1 1.0
	 */
	class PSC_1_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'primarysourceone' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'primarysourceone' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'primarysourceone' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'primarysourceone' ),
						'full'    => esc_html__( 'Full text', 'primarysourceone' ),
					),
				)
			);
			...
			$wp_customize->register_control_type( 'PSC_1_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new PSC_1_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'primarysourceone' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
